...
export class BiographyComponent {
  ...
  biographyBlocs = [
    {
      title:"Amadou Bâ, Premier ministre et dauphin du Sénégal",
      altImg:"",
      texts : [
        {text : "Economiste de formation, Amadou Bâ est un Inspecteur principal des Impôts et des Domaines de classe exceptionnelle. Il est aussi Professeur associé à l’Ecole nationale d’Administration (ENA) et au Centre de formation de la BCEAO (Banque centrale des Etats de l’Afrique de l’ouest). Ayant gravi tous les échelons de l’Administration fiscale, il dirige la Direction générale des Impôts et des Domaines de 2006 à 2013. Durant cette période, il apporte de grandes réformes qui conduisent à la modernisation du service."},
    ...
    {
      title:"Premier dans l’administration publique sénégalaise",
      altImg:"",
      texts : [
