...
import { EventWithContentComponent } from './event-with-content/event-with-content.component';
import { EventWithoutContentComponent } from './event-without-content/event-without-content.component';
